angular.module('myHeroTraining').factory('cadastroService', function ($http) {
  ...
  var confirmar = function(params){
    console.log()
    return $http.post('https://myherotraining.herokuapp.com/confirm-account', params);
  }
  var recuperar = function(email){
    console.log()
    return $http.post('https://myherotraining.herokuapp.com/forgot-password', email);
  }
  var trocar = function(model){
    console.log(model)
    return $http.post('https://myherotraining.herokuapp.com/confirm-reset', model);
  }
